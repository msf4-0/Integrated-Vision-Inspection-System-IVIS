...
# and also to create .streamlit/secrets.toml file
RUN mkdir /home/myuser/code/resources/pretrained_model_tables && \
    chown myuser /home/myuser/code/resources/pretrained_model_tables && \
    chown myuser /home/myuser/code/.streamlit
