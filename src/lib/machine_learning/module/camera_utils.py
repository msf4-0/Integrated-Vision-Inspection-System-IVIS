"""
Title: Camera Utils (DEPRECATED)
Date: 1/7/2021
Author: Chu Zhen Hao
Organisation: Malaysian Smart Factory 4.0 Team at Selangor Human Resource Development Centre (SHRDC)
Description: Camera property utilities

* PREVIOUSLY USED TO DETECT SYSTEM PLATFORM AND INDEX VIDEO CAPTURE DEVICES
* NOT IMPLEMENTING ANYMORE AS UTILISING UserMediaDevices for WebRTC
