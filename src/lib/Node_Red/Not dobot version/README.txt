...
Go to the hamburger menu on the top right corner and select import, then upload the js file Flow_Labels_View into node-red 
Click deploy on the top right corner 
To bring up the UI enter http://127.0.0.1:1880/ui into the web broswer 
The python file which will create the CSV file has to be run before anything is done in node-red 
