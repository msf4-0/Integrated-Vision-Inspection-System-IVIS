...
from core.utils.helper import get_filetype
...
def editor(data_id: List = []):
    ...
    # session_state.project.dataset_list = session_state.project.load_dataset() # NOTE to remove?
    # ******** SESSION STATE *********************************************************
    # Page title
...
# ************************* CALLBACK FUNCTION ************************************
    ...
    def check_if_task_exist(project_id, dataset_id, conn):
        log_info("Enter Callback to check task")
        session_state.new_annotation_flag = 0
