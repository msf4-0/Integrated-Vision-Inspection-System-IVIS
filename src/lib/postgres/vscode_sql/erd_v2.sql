...
INSERT INTO public.users (emp_id,
                          username,
                          first_name,
                          last_name,
                          email,
...
CREATE TRIGGER pre_trained_models_update
    BEFORE UPDATE
    ON public.pre_trained_models
    FOR EACH ROW
EXECUTE PROCEDURE trigger_update_timestamp();

ALTER TABLE public.pre_trained_models
    OWNER TO shrdc;
...
CREATE TRIGGER pre_trained_models_update
    BEFORE UPDATE
    ON public.user_upload_models
    FOR EACH ROW
EXECUTE PROCEDURE trigger_update_timestamp();

ALTER TABLE public.user_upload_models
    OWNER TO shrdc;
