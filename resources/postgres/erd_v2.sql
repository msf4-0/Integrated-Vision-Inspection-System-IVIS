...
['Login', 'Project', 'Dataset', 'Editor', 'Model Training']),
(
    'Annotator',
['Login', 'Project', 'Dataset', 'Editor']);
...
CREATE TABLE public.session_log (
    ...
    PRIMARY KEY (id),
    CONSTRAINT fk_user_id FOREIGN KEY (user_id) REFERENCES public.user (id) ON DELETE NO ACTION)
TABLESPACE image_labelling;
