...
CREATE TABLE public.session_log (
    id bigint NOT NULL GENERATED ALWAYS AS IDENTITY (
        CYCLE INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1
    ),
...
ALTER TABLE
    public."user"
ADD
    FOREIGN KEY (role_id) REFERENCES public.role (id) NOT VALID;
...
ALTER TABLE
    public.training_log
ADD
    FOREIGN KEY (training_id) REFERENCES public.training (id) NOT VALID;

ALTER TABLE
    public.training
ADD
    FOREIGN KEY (pre_trained_model_id) REFERENCES public.pre_trained_models (id) NOT VALID;
...
ALTER TABLE
    public.predictions
ADD
    FOREIGN KEY (model_id) REFERENCES public.models (id) NOT VALID;

ALTER TABLE
    public.project
ADD
    FOREIGN KEY (dataset_id) REFERENCES public.dataset (id) NOT VALID;
...
ALTER TABLE
    public.task
ADD
    FOREIGN KEY (prediction_id) REFERENCES public.predictions (id) NOT VALID;
...
ALTER TABLE
    public.annotations
ADD
    FOREIGN KEY (task_id) REFERENCES public.task (id) NOT VALID;

ALTER TABLE
    public.annotations
ADD
    FOREIGN KEY (project_id) REFERENCES public.project (id) NOT VALID;
